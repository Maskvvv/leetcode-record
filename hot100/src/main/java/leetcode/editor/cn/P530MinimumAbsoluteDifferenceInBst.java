...
public class P530MinimumAbsoluteDifferenceInBst {
    public static void main(String[] args) {
        ...
        TreeNode node = TreeUtils.stringToTreeNode("[4,2,6,1,3]");
        System.out.println(solution.getMinimumDifference(node));
    }
    ...
    class Solution {
        ...
        public void dfs(TreeNode root) {
            ...
            if (pre != null && (root.val - pre.val) < res) res = (root.val - pre.val);
            pre = root;
